...
export default {
  async up(queryInterface, Sequelize) {
    const configuracionExists = await queryInterface
      .describeTable('configuracion_campos')
      .then(() => true)
      .catch(() => false);
    ...
    const templatesExists = await queryInterface
      .describeTable('templates_industria')
      .then(() => true)
      .catch(() => false);
    if (!templatesExists) {
